...
namespace WebAppRelation.Migrations
{
    ...
    [Migration("20231212140013_AddBookItms")]
    partial class AddBookItms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppRelation.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebAppRelation.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebAppRelation.Models.BasketItem", b =>
                {
                    ...
                    b.HasOne("WebAppRelation.Models.Order", "Order")
                        .WithMany("BasketItems")
